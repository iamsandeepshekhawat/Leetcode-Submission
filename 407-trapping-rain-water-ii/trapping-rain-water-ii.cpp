...
public:
    int trapRainWater(vector<vector<int>>& heightMap) {
        ...
        // Step1 Push all boundary elements as START points
        ...
        // Step2 Apply BFS similar to level-order traversal
        int level=0;
        int trapped_water=0;
        vector<int>dir={-1,0,1,0,-1}; // Up Right Down Left(URDL) 4-dir calls
